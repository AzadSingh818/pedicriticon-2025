...
export default function PedicriticonHomepage() {
  ...
  const handleAbstractSubmission = () => {
    window.location.href = '/abstract-guidelines';
  };
  ...
  const conferenceStats = [
    ...
    { icon: FileText, label: 'Abstract Categories', value: '4', color: 'green' },
  ...
  const abstractCategories = [
    ...
    { 
      title: 'Case Report', 
      duration: 'e-Poster only', 
      wordLimit: '300 words',
      icon: FileText,
      description: 'Clinical case presentations (e-Poster format only)'
    }
  ];
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                ...
                <ul className="text-sm text-yellow-700 space-y-1">
                  <li>• Case reports will only be considered for e-posters</li>
                  <li>• Research papers not selected for 'Oral' presentation will be considered for 'e-Poster'</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              onClick={() => window.open('mailto:karpedicriticon2025@gmail.com', '_blank')}
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-gray-400">
                ...
                <div className="flex items-center">
                  ...
                  <span>Dr. Arun: +91 96209 22200</span>
                </div>
                <div className="flex items-center">
                  <Phone className="h-4 w-4 mr-2" />
                  <span>Dr. Kumar: +91 94496 26525</span>
                </div>
                <div className="flex items-center">

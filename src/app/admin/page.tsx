...
export default function AdminDashboard() {
  ...
  // 👉 FIXED: Correct 4 categories for PEDICRITICON 2025
  ...
  // 👉 PEDICRITICON 2025 Categories (4 categories only)
  const PEDICRITICON_CATEGORIES = [
    { value: 'all', label: 'All Categories' },
    { value: 'Article', label: 'Original Articles' },
    { value: 'Award Paper', label: 'Award Paper' },
    { value: 'Case Report', label: 'Case Report' },
    { value: 'PICU Case Cafe', label: 'PICU Case Café' }
  ]
  ...
  // 👉 FIXED: Calculate Category Stats with correct mapping
  ...
  // 👉 FIXED: Fetch function with proper API endpoint
